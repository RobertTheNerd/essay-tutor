// ISEE Upper Level (Grades 7-8) Rubric Configuration
...
export const ISEEUpperLevelRubric: EvaluationRubric = {
  ...
  description: 'Enhanced complexity and sophistication requirements for middle school students',
  ...
  categories: [
    ...
    },
    {
      ...
      description: 'Exceptional techniques, sophisticated elements, standout qualities',
      color: '#10b981', // Teal
      weight: 0.1
    }
  ]
...
export const ISEEUpperLevelCriteria = {
  grammar: {
    ...
    4: {
      description: 'Strong grammar with minor errors that don\'t impede understanding',
      indicators: [
